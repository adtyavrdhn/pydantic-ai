...
* `web-fetch` - installs [Web Fetch Tool](common-tools.md#web-fetch-tool) dependencies `beautifulsoup4` [PyPI ↗](https://pypi.org/project/beautifulsoup4){:target="_blank"} and `markdownify` [PyPI ↗](https://pypi.org/project/markdownify){:target="_blank"}
